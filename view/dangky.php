                ...
                <form action="index.php?pg=adduser" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="password" class="inputt" id="lname" name="repassword"
                                    placeholder="NHẬP LẠI MẬT KHẨU" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                                <label for="lname">ẢNH NGƯỜI DÙNG </label>
                            </div>
                            <div class="col-75">
                                <input type="file" class="inputt" id="lname" name="email" placeholder="Email" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
